...
```
bash <(curl -Ls https://raw.githubusercontent.com/jk5101784/xs/main/install.sh --ipv4)
```

حل مشکل عدم ارتباط  تماس صوتی و تصویری در اپلیکشن
```
bash <(curl -Ls https://raw.githubusercontent.com/jk5101784/xs/master/fix-call.sh --ipv4)
...
```
bash <(curl -Ls https://raw.githubusercontent.com/jk5101784/xs/main/TCP-Tweaker --ipv4)

```
## فعال سازی SSL
```
bash <(curl -Ls https://raw.githubusercontent.com/jk5101784/xs/main/ssl.sh --ipv4)
```
